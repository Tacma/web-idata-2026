...
export const routeMappings: Record<string, Record<Language, string>> = {
  ...
  cases: { es: '/casos-de-exito/', en: '/case-studies/' },
  insights: { es: '/insights/', en: '/insights/' },
  about: { es: '/nosotros/', en: '/about/' },
  careers: { es: '/talento/', en: '/careers/' },
  jobs: { es: '/talento/ofertas/', en: '/careers/jobs/' },
...
export function getJobRoute(slug: string, language: Language): string {
  const base = language === 'es' ? '/es/talento/ofertas/' : '/en/careers/jobs/';
  return `${base}${slug}`;
}
