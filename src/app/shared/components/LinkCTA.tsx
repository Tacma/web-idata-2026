...
export function LinkCTA({
  ...
  const variantClasses = {
    ...
    secondary:
      'bg-white/80 backdrop-blur-sm text-[#4387DF] px-6 py-3 rounded-xl hover:bg-white hover:shadow-lg border border-white/60 dark:text-[#7BB5FF]',
    text: 'text-[#4387DF] hover:gap-3 dark:text-[#7BB5FF]',
  };
