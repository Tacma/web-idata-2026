...
export interface BaseEntity extends LocalizedContent {
  ...
  createdAt: string;
  updatedAt: string;
  content_blocks?: ContentBlock[]; // Modular content blocks for article body
}
...
export interface BlogPost extends BaseEntity {
  ...
  relatedIndustries?: string[]; // Related industry IDs
  socialImage?: string; // Custom image for social sharing
  displayVariant?: 'hero-large' | 'tall' | 'standard' | 'wide' | 'medium-v' | 'medium-h' | 'compact'; // Card variant for editorial grid
}
