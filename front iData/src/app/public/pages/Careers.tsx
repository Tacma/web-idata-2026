...
// Hero banner image
import careersBannerImage from 'figma:asset/57c6301ab7145ee9f1d118169ba33db8ad13999c.png';

// Culture section image
import cultureImage from 'figma:asset/ed370e692ad7f1e382eb99fbc6beef86c1da4251.png';
...
export function Careers() {
  ...
  // SEO Content
  const seoTitle = language === 'es' ? 'Trabaja con nosotros - iData' : 'Work with us - iData';
  ...
  // Mock job openings (in real app, this would come from backend/CMS)
  const jobOpenings = [
    {
      id: 1,
    ...
    },
    {
      ...
      modality: 'hybrid',
      location_es: 'México / Híbrido',
      location_en: 'Mexico / Hybrid',
      seniority: 'mid',
      employment_type: 'full-time',
      short_summary_es: 'Únete a nuestro equipo para desarrollar modelos de machine learning que impulsen decisiones estratégicas.',
      short_summary_en: 'Join our team to develop machine learning models that drive strategic decisions.',
    ...
    },
    {
      ...
      seniority: 'mid',
      employment_type: 'full-time',
      short_summary_es: 'Construye pipelines de datos y dashboards que transformen datos en insights accionables.',
      short_summary_en: 'Build data pipelines and dashboards that transform data into actionable insights.',
  ...
  const locations = ['Colombia', 'México', 'Latam'];
    ...
    <>
      ...
      <section className="px-6 sm:px-8 lg:px-12 pt-8 pb-8 mt-20">
        <div className="max-w-[1400px] mx-auto">
          <div className="relative min-h-[420px] rounded-3xl overflow-hidden shadow-xl flex items-center bg-gradient-to-br from-purple-900 via-purple-800 to-blue-900">
            {/* Background Image */}
            <div 
              className="absolute inset-0 bg-cover bg-center"
              style={{
                backgroundImage: `url(${careersBannerImage})`,
              }}
            />
