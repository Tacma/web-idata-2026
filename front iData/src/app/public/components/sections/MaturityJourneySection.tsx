    ...
    <Section background="gray" padding="xl">
      <Container>
        {section.title && (
          ...
          >
            <h2 className="text-3xl md:text-4xl mb-4 text-gray-900 font-light">
              {section.title}
            </h2>
            {section.subtitle && (
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {levels.map((level: any, index: number) => {
            ...
            return (
              <motion.div 
                key={index}
                className="relative bg-white/80 backdrop-blur-sm rounded-3xl hover:shadow-2xl transition-all duration-300 border border-white/60 group"
              ...
              >
                ...
                {/* Content area */}
                <div className="p-6">
                  <h3 className="text-xl mb-2 text-gray-900 font-light">
                    {level.title}
                  </h3>
