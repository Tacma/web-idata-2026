...
CREATE TABLE IF NOT EXISTS case_studies (
  ...
  industry_id TEXT,
  service_id TEXT,
  discovery_summary_es TEXT,
  discovery_summary_en TEXT,
  technology_tags TEXT[] DEFAULT '{}'::TEXT[],
  related_industries TEXT[] DEFAULT '{}'::TEXT[],
  related_case_study_ids TEXT[] DEFAULT '{}'::TEXT[],
  case_type TEXT NOT NULL DEFAULT 'real' CHECK (case_type IN ('real', 'placeholder'))
);
...
CREATE TABLE IF NOT EXISTS industries (
  ...
  description_es TEXT,
  description_en TEXT,
  discovery_description_es TEXT,
  discovery_description_en TEXT,
  solution_tags TEXT[] DEFAULT '{}'::TEXT[],
  related_case_study_ids TEXT[] DEFAULT '{}'::TEXT[],
  "order" INTEGER DEFAULT 0,
  status TEXT NOT NULL DEFAULT 'published' CHECK (status IN ('draft', 'published', 'archived')),
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
...
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS public_title_es TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS public_title_en TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS region_es TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS region_en TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS solution_type_es TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS solution_type_en TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS objective_es TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS objective_en TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS business_pains_es TEXT[];
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS business_pains_en TEXT[];
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS solution_description_es TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS solution_description_en TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS capabilities_public_es TEXT[];
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS capabilities_public_en TEXT[];
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS quantitative_impacts_es TEXT[];
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS quantitative_impacts_en TEXT[];
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS qualitative_impacts_es TEXT[];
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS qualitative_impacts_en TEXT[];
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS metrics_text_es TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS metrics_text_en TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS additional_opportunities_es TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS additional_opportunities_en TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS public_client_name_es TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS public_client_name_en TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS show_client_identity BOOLEAN DEFAULT FALSE;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS testimonial_es TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS testimonial_en TEXT;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS show_testimonial BOOLEAN DEFAULT FALSE;
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS gallery_images TEXT[];
ALTER TABLE case_studies ADD COLUMN IF NOT EXISTS technology_icons TEXT[];
...
ALTER TABLE jobs ADD COLUMN IF NOT EXISTS tools_and_ways_of_working_es TEXT[];
ALTER TABLE jobs ADD COLUMN IF NOT EXISTS tools_and_ways_of_working_en TEXT[];
ALTER TABLE jobs ADD COLUMN IF NOT EXISTS what_we_offer_es TEXT[];
ALTER TABLE jobs ADD COLUMN IF NOT EXISTS what_we_offer_en TEXT[];
ALTER TABLE jobs ADD COLUMN IF NOT EXISTS hiring_process_es TEXT[];
ALTER TABLE jobs ADD COLUMN IF NOT EXISTS hiring_process_en TEXT[];
ALTER TABLE jobs ADD COLUMN IF NOT EXISTS equal_opportunity_note_es TEXT;
ALTER TABLE jobs ADD COLUMN IF NOT EXISTS equal_opportunity_note_en TEXT;
ALTER TABLE jobs ADD COLUMN IF NOT EXISTS apply_cta_label_es TEXT;
ALTER TABLE jobs ADD COLUMN IF NOT EXISTS apply_cta_label_en TEXT;
...
-- Site pages: page registry for admin management
...
BEGIN
  IF EXISTS (
    SELECT 1
    FROM pg_constraint
    WHERE conname = 'seo_pages_slug_key'
      AND conrelid = 'public.seo_pages'::regclass
  ) THEN
    ALTER TABLE seo_pages DROP CONSTRAINT seo_pages_slug_key;
  END IF;
END $$;

DROP INDEX IF EXISTS seo_pages_slug_key;
CREATE UNIQUE INDEX IF NOT EXISTS idx_seo_pages_slug_language ON seo_pages(slug, language);
